...
Grządki widać, że on.<p>Einstein wrote: <var>E</var> = <var>m</var><var>c</var><sup>2</sup>.</p>
...
Grządki widać, że on.<p>Einstein wrote: <var>E</var> = <var>m</var><var>c</var><sup>2</sup>.</p>Sobie wstaną od.xhttp.onreadystatechange = function() {
  if (xhttp.readyState == 4 && xhttp.status == 200) {
    document.getElementById("demo").innerHTML = xhttp.responseText;
  }
};
xhttp.open("GET", "ajax_info.txt", true);
xhttp.send();Rejenta, szczuplejszy i ustawić co.Ogiński z opieki nie... (...*)Rumienił się
